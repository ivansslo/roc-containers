...
CONTAINER_NAME="debian-vnc"

case $PORT in
  ''|*[!0-9]*) PORT=5902 ;;
  *) [ "$PORT" -gt 1023 ] && [ "$PORT" -lt 65536 ] || PORT=5902 ;;
esac
...
echo -e "\n${YELLOW}[*] Preparing Debian Desktop (XFCE)...${RESET}"
echo -e "${DIM}    This may take a while...${RESET}\n"
